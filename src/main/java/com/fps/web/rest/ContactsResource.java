...
public class ContactsResource {
     ...
     * @return the result of the search
     */
    @RequestMapping(value = "/_search/modal/contacts",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    ...
    @RequestMapping(value = "/cons",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Objects[]>> getAllContactss(Pageable pageable)
        throws URISyntaxException {
        log.debug("REST request to get a page of Contacts");
    ...
    @RequestMapping(value = "/elastic/cons",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Iterable<Contacts>> getAllContactsFromElastic()
        throws URISyntaxException {
        log.info("-----------------------------------------------------------");
    ...
    @RequestMapping(value = "/database/cons",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Iterable<Contacts>> getAllContactsFromDatabase()
        throws URISyntaxException {
        log.info("------------------------------------------------------------");
