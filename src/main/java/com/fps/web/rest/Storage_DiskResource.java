...
public class Storage_DiskResource {
     ...
     *
     * @param storage_Disk the storage_Disk to create
     * @return the ResponseEntity with status 201 (Created) and with body the new storage_Disk, or with status 400 (Bad Request) if the storage_Disk has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @RequestMapping(value = "/storage-disks",
        method = RequestMethod.POST,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Storage_Disk> createStorage_Disk(@RequestBody Storage_Disk storage_Disk) throws URISyntaxException {
        log.debug("REST request to save Storage_Disk : {}", storage_Disk);
        if (storage_Disk.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert("storage_Disk", "idexists", "A new storage_Disk cannot already have an ID")).body(null);
        }
        ...
        return ResponseEntity.created(new URI("/api/storage-disks/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert("storage_Disk", result.getId().toString()))
            .body(result);
    }
     ...
     *
     * @param storage_Disk the storage_Disk to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated storage_Disk,
     * or with status 400 (Bad Request) if the storage_Disk is not valid,
     * or with status 500 (Internal Server Error) if the storage_Disk couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @RequestMapping(value = "/storage-disks",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Storage_Disk> updateStorage_Disk(@RequestBody Storage_Disk storage_Disk) throws URISyntaxException {
     ...
     * @return the ResponseEntity with status 200 (OK) and the list of storage_Disks in body
    ...
    @RequestMapping(value = "/storage-disks",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Storage_Disk>> getAllStorage_Disks(Pageable pageable)
     ...
     *
     * @param id the id of the storage_Disk to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the storage_Disk, or with status 404 (Not Found)
     */
    @RequestMapping(value = "/storage-disks/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Storage_Disk> getStorage_Disk(@PathVariable Long id) {
        ...
        return Optional.ofNullable(storage_Disk)
     ...
     *
     * @param id the id of the storage_Disk to delete
    ...
    /**
     * SEARCH  /_search/storage-disks?query=:query : search for the storage_Disk corresponding
     * to the query.
     *
     * @param query the query of the storage_Disk search
     * @return the result of the search
     */
    @RequestMapping(value = "/_search/storage-disks",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<Storage_Disk>> searchStorage_Disks(@RequestParam String query, Pageable pageable)
        ...
        HttpHeaders headers = PaginationUtil.generateSearchPaginationHttpHeaders(query, page, "/api/_search/storage-disks");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
