...
public class WorkOrderResource {
     ...
     *
     * @param workOrderDTO the workOrder to create
     * @return the ResponseEntity with status 201 (Created) and with body the new workOrder, or with status 400 (Bad Request) if the workOrder has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @RequestMapping(value = "/work-orders",
     ...
     *
     * @param workOrderDTO the workOrder to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated workOrder,
     * or with status 400 (Bad Request) if the workOrder is not valid,
     * or with status 500 (Internal Server Error) if the workOrder couldnt be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @RequestMapping(value = "/work-orders",
    ...
    @RequestMapping(value = "/work-orders",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<WorkOrder>> getAllWorkOrders(Pageable pageable)
     ...
     * @return the ResponseEntity with status 200 (OK) and with body the workOrder, or with status 404 (Not Found)
     */
    @RequestMapping(value = "/work-orders/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
     ...
     */
    @RequestMapping(value = "/_search/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
     ...
     * @return the result of the search
     */
    @RequestMapping(value = "/_search/filters/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<WorkOrder> searchWorkOrdersOnCriteria(@RequestParam String query, @RequestParam String filter)
        ...
        if (filter.equals("project")) {
            ...
            workOrders = (List) workOrderSearchRepository.findOne(Long.valueOf(query));
        } else if (filter.equals("name")) {

        } else if (filter.equals("description")) {
            workOrders = (List) workOrderSearchRepository.findByRequestDescription(query);
        } else if (filter.equals("invoice")) {
            workOrders = (List) workOrderSearchRepository.findByInvoiced(query);
        }
     ...
     * @throws URISyntaxException
     */
    @RequestMapping(value = "/reports/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<WorkOrderListDTO> workOrderReports(@RequestParam String reportType)
        throws URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    @RequestMapping(value = "/openworkorders/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<WorkOrderListDTO> openWorkOrders()
        throws URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    @RequestMapping(value = "/grouped/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<WorkOrderListDTO> openWorkOrdersGrouped()
        throws URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    @RequestMapping(value = "/audit/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<WorkOrderListDTO> toAudit()
        throws URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    @RequestMapping(value = "/invoice/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<WorkOrder> toInvoice()
        throws URISyntaxException {
        currentTenantIdentifierResolver.setTenant(SLAVE);
     ...
     * @throws URISyntaxException
     */
    @RequestMapping(value = "/my-open/work-orders",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<WorkOrder> myOpenWO()
        throws URISyntaxException {
        currentTenantIdentifierResolver.setTenant(SLAVE);

        User user = userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).get();

        //final List<WorkOrder> workOrderList = workOrderRepository.findByAssignedToUserIsCurrentUser();
