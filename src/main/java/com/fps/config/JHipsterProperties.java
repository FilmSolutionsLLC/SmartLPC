...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "SmartLPC@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "SmartLPC API";

        private String description = "SmartLPC API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "SmartLPC";
