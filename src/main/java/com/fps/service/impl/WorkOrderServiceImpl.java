...
public class WorkOrderServiceImpl implements WorkOrderService {
	...
	public WorkOrderDTO findOne(Long id) {
		...
		// final List<WorkOrdersAdminRelation> workOrdersAdminRelations =
		// workOrdersAdminRelationRepository.findByWorkOrder(workOrder);
		...
		// final Set<WorkOrdersAdminRelation> workOrdersAdminRelationSet = new
		// HashSet<>(workOrdersAdminRelations);
