...
(function () {
    ...
    ProjectListController.$inject = ['ContactPrivileges', 'ProjectsSearch', 'Projects', '$http', '$rootScope', 'Contacts', 'Lookups', 'Departments', 'User', 'ContactsSearch', 'AlertService', '$uibModalInstance', '$scope', '$state'];

    function ProjectListController(ContactPrivileges, ProjectsSearch, Projects, $http, $rootScope, Contacts, Lookups, Departments, User, ContactsSearch, AlertService, $uibModalInstance, $scope, $state) {
        ...
        vm.addFilter = function () {
            vm.filters.push({"id": vm.filters.length + 1});
        };
        ...
        vm.selectProject = function (project) {
            if (vm.selectedProjects.indexOf(project) == -1) {
                ...
                console.log("Checking  :  " + vm.selectedProjects[project.id]);
                console.log("contact selected : " + project.id);
            } else {
        ...
        vm.removeSelected = function (index) {
            ...
            console.log("removing id : " + vm.selectedCheckBox[vm.selectedProjects[index].id]);
        ...
        $rootScope.$watch(function () {
            ...
            if ($rootScope.savedContact == null) {
                ...
                console.log("Saved contact  :  " + JSON.stringify($rootScope.savedContact));
        ...
        vm.save = function () {
            ...
            console.log("total size of project: " + $rootScope.selectedProjects.length);
