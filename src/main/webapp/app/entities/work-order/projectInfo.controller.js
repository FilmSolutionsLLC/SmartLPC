...
(function () {
    ...
    angular
        .module('smartLpcApp')
        .controller('WorkOrderAuditController', WorkOrderAuditController);

    WorkOrderAuditController.$inject = ['$http', '$scope', '$state'];
    ...
    function WorkOrderAuditController($http, $scope, $state) {
        ...
        $http({
            ...
            //console.log("GroupWorkOrders : " + JSON.stringify(vm.groupedWorkOrders));
        });
        ...
        $http({
            ...
            method: "GET",
            params: {query: 'PO 7654', filter: 'description'}
        }).then(function (response) {
            vm.wo = response.data;
